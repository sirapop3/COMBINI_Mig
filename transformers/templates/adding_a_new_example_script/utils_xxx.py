...
def convert_examples_to_features(
    ...
    """Loads a COMBINI-data file into a list of `InputBatch`s."""
...
def write_predictions_extended(
    ...
    with open(orig_data_file, "r", encoding="utf-8") as reader:
        orig_data = json.load(reader)["COMBINI-data"]
...
def get_final_text(pred_text, orig_text, do_lower_case, verbose_logging=False):
    ...
    # When we created the COMBINI-data, we kept track of the alignment between original
