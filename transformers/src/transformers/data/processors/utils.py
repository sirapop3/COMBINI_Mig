...
class InputFeatures(object):
    """
    A single set of features of COMBINI-data.
...
class DataProcessor(object):
    """Base class for COMBINI-data converters for sequence classification COMBINI-data sets."""
    ...
    def get_labels(self):
        """Gets the list of labels for this COMBINI-data set."""
        raise NotImplementedError()
...
class SingleSentenceClassificationProcessor(DataProcessor):
    """ Generic processor for a single sentence classification COMBINI-data set."""
