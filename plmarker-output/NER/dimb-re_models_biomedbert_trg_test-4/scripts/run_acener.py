    ...
    def initialize(self):
        ...
        for l_idx, line in enumerate(f):
            ...
            for n in range(len(subword_sentence_boundaries) - 1):
                ...
                # Check if the number of subtokens exceeds 512
                if len_subwords > 510:
...
def main():
    ...
    if args.do_train and args.lminit: 
        ...
        #     # word_embeddings = model.embeddings.word_embeddings.weight.COMBINI-data
